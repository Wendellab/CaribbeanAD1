...
grep -v '#' $output.AhDh.combined.vcf | wc -l
vcftools --vcf $output.AhDh.combined.vcf --freq2
...
#/lustre/hdd/LAS/jfw-lab/weixuan/07_PRGD_popgene/03_AD1AD2AD4/Dsuite/Build/Dsuite Dinvestigate -w 50,25 ../$output.vcf sets.txt ${output}_trios.txt
